...
const Sprite = function(ctx, x, y) {
    ...
    const drawSprite = function() {
        ...
        /* TODO */        
        // Draw current frame with proper scaling and centering
        const srcX = sequence.x + (index * sequence.width);
        ctx.imageSmoothingEnabled = false; // clear img when size is bigger
        ctx.drawImage(sheet, srcX, sequence.y
